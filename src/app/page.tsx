...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between mt-10 py-24 px-5 sm:px-10 bg-white">
      <div className="w-full h-full bg-cover bg-center text-black bg-no-repeat">
        <h1 className="text-2xl sm:text-3xl font-bold italic text-center">
          <i className="not-italic">Hello</i>, I am Ahmed Raza!
        </h1>
        
        <p className="mt-4 text-justify mx-4 sm:mx-8 md:mx-12 lg:mx-20">
